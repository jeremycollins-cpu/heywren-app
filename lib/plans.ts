...
export const FEATURES: Record<string, FeatureDefinition> = {
  ...
  the_signal:       def('the_signal',       'The Signal',         'AI-synthesized executive intelligence — highlights, risks, priorities, and projects drawn from emails, chats, calendar, meetings, and documents you upload. Scales from daily glance to board-ready output.', 'pro', '/the-signal'),
...
export const PLAN_DISPLAY: Record<DisplayablePlan, PlanDisplay> = {
  pro: {
    ...
    features: [
      ...
      'The Signal — executive intelligence',
      'Rapid triage mode',
