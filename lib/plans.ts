...
export const FEATURES: Record<string, FeatureDefinition> = {
  ...
  monthly_briefing: def('monthly_briefing', 'Monthly Briefing',   'AI-synthesized monthly overview of your business — highlights, risks, priorities, and projects drawn from emails, chats, calendar, meetings, and documents you upload.', 'pro', '/monthly-briefing'),
