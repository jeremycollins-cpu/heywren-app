    ...
    <div className="p-6 max-w-[1200px] mx-auto space-y-6">
        ...
        {[
          {
            ...
            color: thisWeekNew.length > 0 ? 'text-gray-900' : 'text-gray-400',
          ...
          },
          {
            ...
            label: 'Still Open',
            value: open.length,
            color: open.length > 20 ? 'text-yellow-600' : 'text-gray-900',
            sub: null,
            subColor: 'text-gray-400'
          },
          {
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5">
        ...
        {commitments.length === 0 ? (
          <p className="text-gray-500 text-sm">No commitments tracked yet. Source breakdown will appear as data flows in.</p>
        ) : (
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="flex items-center gap-3 bg-gray-50 rounded-lg p-3">
              ...
              <div>
                ...
                <div className="text-xl font-bold text-gray-900">{manualCount}</div>
              </div>
            </div>
          </div>
        )}
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5">
        ...
        {commitments.length === 0 ? (
          <p className="text-gray-500 text-sm">Activity will appear here as commitments are tracked.</p>
        ) : (
          <div className="space-y-3">
                ...
                <div className="flex items-center gap-2 text-xs text-gray-400">
                  {c.source && (
                    <span className={`px-1.5 py-0.5 rounded font-medium ${
                      c.source === 'slack' ? 'bg-purple-100 text-purple-600' :
                      c.source === 'outlook' || c.source === 'email' ? 'bg-blue-100 text-blue-600' :
