...
export default function MissedChatsPage() {
  ...
  if (loading) {
    return (
      <div className="p-8" role="status" aria-live="polite" aria-busy="true" aria-label="Loading missed chats">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">
            Slack messages where you were mentioned but never responded to the thread
          </p>
        </div>
        <button
          onClick={triggerScan}
